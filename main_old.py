...
async def push_context(request: Request):
    ...
    # Reject only if incoming version is older
    ...
    # Same version = idempotent success
    if version == current_version:
        return {
            "accepted": True,
...
async def tick(request: Request):
    ...
    for trigger_id in available_triggers:
        ...
        try:
            ...
            result = {
                "body": "We noticed an important update for your business. Would you like a quick summary and recommended next steps?",
                "cta": "binary_yes_no",
                "send_as": "merchant_on_behalf" if customer_id else "vera",
                "rationale": "Fallback message because AI generation failed."
            }
